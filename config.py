...
ANALYTICS_NETWORKS_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_NETWORKS_CACHE_TTL_SECONDS', 300))
ANALYTICS_OVERVIEW_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_OVERVIEW_CACHE_TTL_SECONDS', 300))
ANALYTICS_RISK_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_RISK_CACHE_TTL_SECONDS', 300))
