...
ANALYTICS_RELATIONSHIPS_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_RELATIONSHIPS_CACHE_TTL_SECONDS', 1800))
ANALYTICS_NETWORKS_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_NETWORKS_CACHE_TTL_SECONDS', 1800))
ANALYTICS_OVERVIEW_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_OVERVIEW_CACHE_TTL_SECONDS', 1800))
ANALYTICS_RISK_CACHE_TTL_SECONDS = int(os.environ.get('ANALYTICS_RISK_CACHE_TTL_SECONDS', 1800))
